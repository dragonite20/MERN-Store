...
function Header({
  ...
  return __jsx(external_semantic_ui_react_["Menu"], {
  ...
  }), "MERN STORE")), __jsx(link_default.a, {
    href: "/cart"
  }, __jsx(external_semantic_ui_react_["Menu"].Item, {
    header: true,
    ...
    name: "cart",
    size: "large"
  }), "Cart")), isRootOrAdmin && __jsx(link_default.a, {
    href: "/create"
  }, __jsx(external_semantic_ui_react_["Menu"].Item, {
    header: true,
    ...
    name: "user",
    size: "large"
  }), "Account")), __jsx(external_semantic_ui_react_["Menu"].Item, {
...
class _app_MyApp extends app_default.a {
  constructor(...args) {
    ...
    Object(defineProperty["a" /* default */])(this, "syncLogout", event => {
      if (event.key === "logout") {

...
const stripe = stripe__WEBPACK_IMPORTED_MODULE_0___default()("<insert-stripe-secret-key>");
/* harmony default export */ __webpack_exports__["default"] = (async (req, res) => {
  ...
  try {
    ...
    const {
      userId
    } = jsonwebtoken__WEBPACK_IMPORTED_MODULE_2___default.a.verify(req.headers.authorization, "<insert-jwt-secret>"); // 2) Find cart based on user id, populate it
    ...
    const {
      cartTotal,
      stripeTotal
    } = Object(_utils_calculateCartTotal__WEBPACK_IMPORTED_MODULE_5__[/* default */ "a"])(cart.products); // 4) Get email from payment data, see if email linked with existing Stripe customer
